          ...
          <div className="p-4 space-y-3">
            ...
            {Object.entries(BLOCK_TYPE_CONFIG).map(([type, config]) => (
              <div key={type} className="space-y-2">
                ...
                {/* AI button moved to the Block Editor */}
                {!isCollapsed && (
                  <div className="w-full p-2 text-left rounded-lg border-2 border-dashed border-gray-200 text-sm text-gray-500">
                    AI generator now available in the block editor
                  </div>
                )}
              </div>
            ))}
