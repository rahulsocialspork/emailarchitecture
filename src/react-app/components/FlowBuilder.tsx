...
export default function FlowBuilder({
  ...
  useEffect(() => {
    ...
    // If we're currently applying an undo/redo operation, skip syncing
    // incoming props into the local history state to avoid overwriting
    // the restored history.present value.
